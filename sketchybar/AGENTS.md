...
- **Architecture:** Separate concerns - CLI (cli.lua), Data (data.lua), Render (workspace.lua)
...
- `plugins/aerospace/workspace.lua` - Creates and updates sketchybar workspace items
